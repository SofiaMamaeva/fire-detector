...
FD_MAX_UPLOAD_BYTES   = int(os.getenv("FD_MAX_UPLOAD_BYTES", str(128 * 1024 * 1024)))
...
async def detect(
    ...
    for i, d in enumerate(dets, start=1):
        ...
        bboxes.append({
            ...
            "model": model,
            "color": MODEL_COLORS_BGR.get(model, (255, 77, 124)),
            "color_hex": MODEL_COLORS_HEX.get(model, "#00cc66"),
    })
